        ...
        if ($result2->num_rows >= 1) {
            ...
            if($allow_emails == "Yes"){
                ...
                if ($budget < $total_spent){
                    $email_body = "<h4 style='font-weight:400'>You have gone above your set budget of &#163;$budget_round per day!<br>You have currently spent &#163;$total_spent_round.<br>To reduce the amount you spend, please consider turning off all electronic devices when not in use, or have heaters or air conditioning units on at a lower setting.<br>Better luck tomorrow!</h4>";
                } else {
                    $email_body = "<h4 style='font-weight:400'>Congratulations, you have gone kept within your set budget of &#163;$budget_round per day!<br>You have currently spent &#163;$total_spent_round.<br>Good luck for tomorrow, keep it up!</h4>";
                }
