      ...
      <div class="accordion md-accordion" id="accordionExGroup4" role="tablist" aria-multiselectable="true">
       ...
       <!-- Accordion card :1 -->
        ...
        <div class="card">
          ...
          <!-- Card header -->
          <div class="card-header" role="tab" id="headingTwo2Group4">
        ...
        <div class="card">
          ...
          <!-- Card header -->
          <div class="card-header" role="tab" id="headingThree3Group4">
        ...
        <div class="card">
          ...
          <!-- Card header -->
          <div class="card-header" role="tab" id="headingFour4Group4">
