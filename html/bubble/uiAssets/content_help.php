                ...
                <table class="helpTable">
                    ...
                    <tr>
                        <td style="cursor:pointer" onclick="openModalHelp('help21', 'arrow21')">
                            What do all of the statistics mean?<div style="height:0px;margin-bottom:-8px;"></div><i class="arrow down" id="arrow21"></i>
                        </td>
                    </tr>
...
<div class="container justify-content-center" style="max-width: 1200px">
      ...
      <div class="accordion md-accordion" id="accordionEx" role="tablist" aria-multiselectable="true">
        ...
        <div class="card">
          ...
          <div id="collapseOne1" class="collapse" role="tabpanel" aria-labelledby="headingOne1"
            ...
            <div class="card-body" style="text-align:justify!important;text-align-last:center!important;">   
                To turn off all devices in your home, perhaps as you're leaving for work,
                there is a button on the home page labelled 'Turn off Home'. Clicking on this button
                will turn off all devices in your home. If you would like to set a timer that will
                automatically turn off your home, click on the clock icon in the top right of the button.
        ...
        <div class="card">
          ...
          <div class="card-header" role="tab" id="headingThree3">
            <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseThree3"
              ...
              <h5 class="mb-0" style="text-align: center">
                Change costings: my budget, energy price or solar panel rating
                <i class="fas fa-angle-down rotate-icon"></i>
              </h5>
            </a>
          </div>
        ...
        <div class="card">
          ...
          <div class="card-header" role="tab" id="headingFour4">
            <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapseFour4"
              aria-expanded="false" aria-controls="collapseThree3">
              <h5 class="mb-0" style="text-align: center">
                What do all of the statistics mean?
                <i class="fas fa-angle-down rotate-icon"></i>
              </h5>
            </a>
          </div>
    ...
    <div class="section-title" id="roomsHelp">
      ...
      <!--Accordion wrapper-->
      <div class="accordion md-accordion" id="accordionExGroup2" role="tablist" aria-multiselectable="true">
    
       <!-- Accordion card :1 -->
        <div class="card">
            <!-- Card header -->
                <div class="card-header" role="tab" id="headingOne1Group2">
        ...
        <div class="card">
          ...
          <!-- Card header -->
          <div class="card-header" role="tab" id="headingTwo2Group2">
        ...
        <div class="card">
          ...
          <!-- Card header -->
          <div class="card-header" role="tab" id="headingThree3Group2">
            <a class="collapsed" data-toggle="collapse" data-parent="#accordionExGroup2" href="#collapseThree3Group2"
              ...
              <h5 class="mb-0" style="text-align: center">
                Review the statistics of a room
                <i class="fas fa-angle-down rotate-icon"></i>
              </h5>
            </a>
          </div>
          ...
          <div id="collapseThree3Group2" class="collapse" role="tabpanel" aria-labelledby="headingThree3Group2"
            ...
            <div class="card-body" style="text-align:justify!important;text-align-last:center!important;">  
                    To review your room's statistics, click on the information button in the top left corner of the room button.
                     This will open up the statistics popup for the room. At the top there is a pie chart diplaying a comparison between the amount this device is costing you against all of the other devices put together. 
                     It is also displayed below the chart, along with the percentage of this device against all others.
                    <br>
                    The second section shows a costing overview for the selected room,
                     with the previous hour, day, month and year statistics all displayed with their estimated costing.
        ...
        <div class="card">
          ...
          <!-- Card header -->
          <div class="card-header" role="tab" id="headingFour4Group2">
        ...
        <div class="card">
          ...
          <!-- Card header -->
          <div class="card-header" role="tab" id="headingFiveGroup2>
    ...
    <div class="section-title" id="roomsHelp">
      ...
      <!--Accordion wrapper-->
      <div class="accordion md-accordion" id="accordionExGroup3" role="tablist" aria-multiselectable="true">
    
       <!-- Accordion card :1 -->
        <div class="card">
            <!-- Card header -->
                <div class="card-header" role="tab" id="headingOne1Group3">
        ...
        <div class="card">
          ...
          <!-- Card header -->
          <div class="card-header" role="tab" id="headingTwo2Group3">
        ...
        <div class="card">
          ...
          <!-- Card header -->
          <div class="card-header" role="tab" id="headingThree3Group3">
        ...
        <div class="card">
          ...
          <!-- Card header -->
          <div class="card-header" role="tab" id="headingFour4Group3">
        ...
        <div class="card">
          ...
          <!-- Card header -->
          <div class="card-header" role="tab" id="headingFiveGroup3>
        ...
        <div class="card">
          ...
          <!-- Card header -->
          <div class="card-header" role="tab" id="headingSixGroup3>
  ...
  <!--Section :5-->      
    <div class="section-title" id="roomsHelp">
      ...
      <!--Accordion wrapper-->
      <div class="accordion md-accordion" id="accordionExGroup4" role="tablist" aria-multiselectable="true">
    
       <!-- Accordion card :1 -->
        <div class="card">
            <!-- Card header -->
                <div class="card-header" role="tab" id="headingOne1Group4">
    ...
    <div class="section-title" id="roomsHelp">
      ...
      <!--Accordion wrapper-->
      <div class="accordion md-accordion" id="accordionExGroup5" role="tablist" aria-multiselectable="true">
    
       <!-- Accordion card :1 -->
        <div class="card">
            <!-- Card header -->
                <div class="card-header" role="tab" id="headingOne1Group5">
        ...
        <div class="card">
          ...
          <!-- Card header -->
          <div class="card-header" role="tab" id="headingTwo2Group5">
          ...
          <!-- Card body -->
          <div id="collapseTwo2Group4" class="collapse" role="tabpanel" aria-labelledby="headingTwo2Group5" data-parent="#accordionExGroup5">
            <div class="card-body" style="text-align:justify!important;text-align-last:center!important;">  
        ...
        <div class="card">
          ...
          <!-- Card header -->
          <div class="card-header" role="tab" id="headingThree3Group5">
            <a class="collapsed" data-toggle="collapse" data-parent="#accordionExGroup5" href="#collapseThree3Group5"
              aria-expanded="false" aria-controls="collapseThree3Group5">
              <h5 class="mb-0" style="text-align: center">
                How to logout
                <i class="fas fa-angle-down rotate-icon"></i>
              </h5>
          ...
          <!-- Card body -->
          <div id="collapseThree3Group5" class="collapse" role="tabpanel" aria-labelledby="headingThree3Group5"
            data-parent="#accordionExGroup5">
            <div class="card-body" style="text-align:justify!important;text-align-last:center!important;">  
        ...
        <div class="card">
          ...
          <!-- Card header -->
          <div class="card-header" role="tab" id="headingFour4Group5">
            <a class="collapsed" data-toggle="collapse" data-parent="#accordionExGroup5" href="#collapseFour4Group5"
              aria-expanded="false" aria-controls="collapseFour4Group5>
              <h5 class="mb-0" style="text-align: center">
          ...
          <!-- Card body -->
          <div id="collapseFour4Group5" class="collapse" role="tabpanel" aria-labelledby="collapseFour4Group5"
            data-parent="#accordionExGroup5">
            <div class="card-body" style="text-align:justify!important;text-align-last:center!important;">  
                To update your account, navigate to the account page, found at the top of the screen on laptops and desktops, 
