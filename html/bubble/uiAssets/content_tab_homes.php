        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                if ($result1->num_rows === 1) {
                    ...
                    $DataSumMonthEncoded = json_encode($dataSumMonths = array_sum($dataPoints), JSON_NUMERIC_CHECK);
                    ...
                    <!-- Card header -->
                        ...
                        <div id="collapse$hub_id" class="collapse show" role="tabpanel" aria-labelledby="heading$hub_id" data-parent="#accordionEx194">
                            ...
                            <!--todo change 3 donuts to carousels-->
                                ...
                                <table>
                                    <tr>
                                        <td><strong>Spent Today:</strong></td>
                                        <td>£$cost_day</td>
                                    </tr>
                                    <tr>
                                        <td><strong>Power Used Today [W]:</strong></td>
                                        <td>$sumDataDay</td>
                                    </tr>
                                    <tr>
                                        <td><strong>Spent This Month:</strong></td>
                                        <td>£$cost_month</td>
                                    </tr>
                                    <tr>
                                        <td><strong>Power Used This Month [W]:</strong></td>
                                        <td>$sumDataMonth</td>
                                    </tr>
                                    <tr>
                                        <td><strong>Spent This Year:</strong></td>
                                        <td>£$cost_total</td>
                                    </tr>
                                    <tr>
                                        <td><strong>Power Used This Year [W]:</strong></td>
                                        <td>$sumDataYear</td>
                                    </tr>
                                </table>
                                <hr>
