...
html;
                ...
                <i class="stats_icon_x " id="room_stats_x_$room_id" style="color:$colour;" onclick="openModalRoom('modal_room_stats_$room_id','room_stats_x_$room_id','room_stats_$room_id')"><i class="fas fa-times"></i></i>
                </div>
                
                </div>
                <div class="modalStatsWrap" id="modal_room_stats_$room_id">
