                    ...
                    <div class="tab-content ">
                        ...
                        <div class="tab-pane fade" id="panel8" role="tabpanel">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="md-form form-sm mb-5">
                                    <i class="fas fa-envelope prefix"></i>
                                    <label data-error="wrong" data-success="right" for="modalLRInput12">Your Name
                                        <input type="text"
                                               id="modalLRInput12"
                                               class="form-control form-control-sm validate"
                                ...
                                <div class="md-form form-sm mb-5">
                                    <i class="fas fa-envelope prefix"></i>
                                    <label data-error="wrong" data-success="right" for="modalLRInput12">Name
                                        <input type="text"
                                               id="modalLRInput12"
                                               class="form-control form-control-sm validate"
                                               placeholder="First name"
                                ...
                                <div class="md-form form-sm mb-5">
                                    ...
                                    <input type="text" id="modalLRInput12"
                                           class="form-control form-control-sm validate">
                                    <label data-error="wrong" data-success="right" for="modalLRInput12">Address line-1
                                        <input type="text"
                                               id="modalLRInput12"
                                               class="form-control form-control-sm validate"
                                ...
                                <div class="md-form form-sm mb-5">
                                    ...
                                    <input type="text" id="modalLRInput12"
                                           class="form-control form-control-sm validate">
                                    <label data-error="wrong" data-success="right" for="modalLRInput12">Address line-2
                                        <input type="text"
                                               id="modalLRInput12"
                                               class="form-control form-control-sm validate"
                                ...
                                <div class="md-form form-sm mb-5">
                                    ...
                                    <input type="text" id="modalLRInput12"
                                           class="form-control form-control-sm validate">
                                    <label data-error="wrong" data-success="right" for="modalLRInput12">Postcode
                                        <input type="text"
                                               id="modalLRInput12"
                                               class="form-control form-control-sm validate"
                                ...
                                <div class="md-form form-sm mb-5">
                                    ...
                                    <input type="text" id="modalLRInput12"
                                           class="form-control form-control-sm validate">
                                    <label data-error="wrong" data-success="right" for="modalLRInput12">Contact Number
                                        <input type="text"
                                               id="modalLRInput12"
                                               class="form-control form-control-sm validate"
                                ...
                                <div class="md-form form-sm mb-4">
                                    ...
                                    <label data-error="wrong" data-success="right" for="modalLRInput14">Repeat password
                                        class="form-control form-control-sm validate">
