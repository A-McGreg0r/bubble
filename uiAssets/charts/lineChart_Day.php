...
<script type="text/javascript">
    ...
    let LineChartDay = new Chart(ctxL, {
        ...
        data: {
            ...
            datasets: [{
                label: "Avrages usage",
                data: [js_data_avg, js_data_avg, js_data_avg, js_data_avg, js_data_avg, js_data_avg, js_data_avg, js_data_avg, js_data_avg, js_data_avg, js_data_avg, js_data_avg, js_data_avg, js_data_avg, js_data_avg, js_data_avg, js_data_avg, js_data_avg, js_data_avg, js_data_avg, js_data_avg, js_data_avg, js_data_avg, js_data_avg],
                backgroundColor: [
                    'rgba(0, 137, 132, .0)',
                ],
                borderColor: [
