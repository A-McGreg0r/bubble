                            ...
                            <div class="card-body pt-0">
                                <div class="flex-sm-row justify-content-center">     
                                    ...
                                    <script type="text/javascript">
                                        ...
                                        var data1 = { "labels": [$dataLablesEncoded],"label": "My First dataset", "datasets": [{ "label": "Contacts", "data": $dataPointsEncoded[0], "backgroundColor": "rgba(255, 99, 132, 0.2)", "borderColor": "rgba(255,99,132,1)", "borderWidth": 1 }] };
